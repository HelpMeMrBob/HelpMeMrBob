                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
							...
							action="editAction.do" enctype="multipart/form-data"> 
							...
							<table class="table table-bordered" id="vsTb">
								...
								<tr>
									...
									<td>
										<%-- ${resultList[0].topic} --%>
										<input type="text" name="topic" value="${viewRow.topic }"
										 style="width:1000px;">
									</td>
								</tr>
								...
								<tr>
									...
									<br><br>
									기존 파일:${viewRow.sfile1 }
								 	<img src="../resources/vsUpload/${viewRow.sfile1 }" style="max-width:100px;" />
									</td>
								</tr>
								<%-- </c:forEach> --%>
								<tr>
									...
									<br><br>
									기존 파일:${viewRow.sfile2 }
								 	<img src="../resources/vsUpload/${viewRow.sfile2 }" style="max-width:100px;" />
									</td>
								</tr>
