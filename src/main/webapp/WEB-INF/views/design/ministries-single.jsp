...
<jsp:include page="/WEB-INF/views/include/globalHeader.jsp" />
  ...
  <body>
    ...
    <main>
      ...
      <section class="banner single-banner-minitries full-width">
        ...
        <div class="container">
          ...
          <div class="banner__content">
            ...
            <div class="breadcrumb">
              ...
              <span>/</span>
              <div class="breadcrumb__home--link"><a href="ministries-layout.html">Ministries</a></div>
              <span>/</span>
      ...
      <section class="single-page single-ministry default-section-spacing">
            ...
            <div class="row">
              ...
              <div class="flex-md-6 flex-lg-4">
                ...
                <div class="icon-text mar-b-sm-06">
                  ...
                  <span class="text bold">Leads by George E. Pugh</span>
                </div><!-- .icon-text ends -->
        ...
        <div class="single-ministry__cta text-center-sm color-off-white default-section-spacing">
          ...
          <h2 class="mar-b-sm-2">We invite you to join our Men's ministry.<br> Don't fear, God is with you</h2>
          <a href="" class="button button--primary button--fill">Join today</a>

        </div><!-- .single-ministry__cta ends -->
      ...
      <!-- RECOMMENDED STARTS -->
      <section class="recommended default-section-spacing pad-t-sm-0">

        <div class="container">

          <div class="section-heading">
            <span class="section-intro">Recommended</span>
            <h2>Check out more ministries</h2>
          </div><!-- .section-heading ends -->
