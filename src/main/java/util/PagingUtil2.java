...
public class PagingUtil2 {
	...
	public static String pagingImg2(
		...
		해당하는 페이지를 구한다.
		*/
		int intTemp = (((nowPage_2-1) / blockPage) * blockPage) + 1;
		...
		*/
		...
		if(intTemp <= totalPage) {
			pagingStr += "<li class='page-item'><a class='page-link' href='"+page+"nowPage_2="+
											intTemp+"'>"
